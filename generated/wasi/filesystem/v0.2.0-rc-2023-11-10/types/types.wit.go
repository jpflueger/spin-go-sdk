...
// Package types represents the interface "wasi:filesystem/types@0.2.0-rc-2023-11-10".
//
...
import (
	wallclock "github.com/fermyon/spin-go-sdk/generated/wasi/clocks/v0.2.0-rc-2023-11-10/wall-clock"
...
// Advice represents the enum "wasi:filesystem/types@0.2.0-rc-2023-11-10#advice".
//
...
//go:wasmimport wasi:filesystem/types@0.2.0-rc-2023-11-10 [method]descriptor.readlink-at
//go:noescape
...
// DescriptorFlags represents the flags "wasi:filesystem/types@0.2.0-rc-2023-11-10#descriptor-flags".
//
// Descriptor flags.
//
...
// DescriptorStat represents the record "wasi:filesystem/types@0.2.0-rc-2023-11-10#descriptor-stat".
//
// File attributes.
//
...
// DescriptorType represents the enum "wasi:filesystem/types@0.2.0-rc-2023-11-10#descriptor-type".
//
...
// DirectoryEntry represents the record "wasi:filesystem/types@0.2.0-rc-2023-11-10#directory-entry".
//
// A directory entry.
//
...
// DirectoryEntryStream represents the resource "wasi:filesystem/types@0.2.0-rc-2023-11-10#directory-entry-stream".
//
...
// ErrorCode represents the enum "wasi:filesystem/types@0.2.0-rc-2023-11-10#error-code".
//
...
// FileSize represents the type "wasi:filesystem/types@0.2.0-rc-2023-11-10#filesize".
//
...
// LinkCount represents the type "wasi:filesystem/types@0.2.0-rc-2023-11-10#link-count".
//
...
// MetadataHashValue represents the record "wasi:filesystem/types@0.2.0-rc-2023-11-10#metadata-hash-value".
//
...
// NewTimestamp represents the variant "wasi:filesystem/types@0.2.0-rc-2023-11-10#new-timestamp".
//
...
// OpenFlags represents the flags "wasi:filesystem/types@0.2.0-rc-2023-11-10#open-flags".
//
...
// PathFlags represents the flags "wasi:filesystem/types@0.2.0-rc-2023-11-10#path-flags".
//
...
// FilesystemErrorCode represents function "wasi:filesystem/types@0.2.0-rc-2023-11-10#filesystem-error-code".
//
