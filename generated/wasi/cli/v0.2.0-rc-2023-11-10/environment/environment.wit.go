...
// Package environment represents the interface "wasi:cli/environment@0.2.0-rc-2023-11-10".
package environment
...
// GetArguments represents function "wasi:cli/environment@0.2.0-rc-2023-11-10#get-arguments".
//
...
// GetEnvironment represents function "wasi:cli/environment@0.2.0-rc-2023-11-10#get-environment".
//
...
// InitialCWD represents function "wasi:cli/environment@0.2.0-rc-2023-11-10#initial-cwd".
//
...
//go:wasmimport wasi:cli/environment@0.2.0-rc-2023-11-10 initial-cwd
//go:noescape
