...
// Package outgoinghandler represents the interface "wasi:http/outgoing-handler@0.2.0-rc-2023-11-10".
//
...
import (
	"github.com/fermyon/spin-go-sdk/generated/wasi/http/v0.2.0-rc-2023-11-10/types"
...
// Handle represents function "wasi:http/outgoing-handler@0.2.0-rc-2023-11-10#handle".
//
...
//go:wasmimport wasi:http/outgoing-handler@0.2.0-rc-2023-11-10 handle
//go:noescape
