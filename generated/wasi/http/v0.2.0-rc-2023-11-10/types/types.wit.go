...
// Package types represents the interface "wasi:http/types@0.2.0-rc-2023-11-10".
//
...
import (
	monotonicclock "github.com/fermyon/spin-go-sdk/generated/wasi/clocks/v0.2.0-rc-2023-11-10/monotonic-clock"
	ioerror "github.com/fermyon/spin-go-sdk/generated/wasi/io/v0.2.0-rc-2023-11-10/error"
	"github.com/fermyon/spin-go-sdk/generated/wasi/io/v0.2.0-rc-2023-11-10/poll"
	"github.com/fermyon/spin-go-sdk/generated/wasi/io/v0.2.0-rc-2023-11-10/streams"
	"github.com/ydnar/wasm-tools-go/cm"
)

// DNSErrorPayload represents the record "wasi:http/types@0.2.0-rc-2023-11-10#DNS-error-payload".
//
...
// TLSAlertReceivedPayload represents the record "wasi:http/types@0.2.0-rc-2023-11-10#TLS-alert-received-payload".
//
...
// ErrorCode represents the variant "wasi:http/types@0.2.0-rc-2023-11-10#error-code".
//
...
// FieldKey represents the type "wasi:http/types@0.2.0-rc-2023-11-10#field-key".
//
...
// FieldSizePayload represents the record "wasi:http/types@0.2.0-rc-2023-11-10#field-size-payload".
//
...
// FieldValue represents the list "wasi:http/types@0.2.0-rc-2023-11-10#field-value".
//
...
// Fields represents the resource "wasi:http/types@0.2.0-rc-2023-11-10#fields".
//
...
//go:wasmimport wasi:http/types@0.2.0-rc-2023-11-10 [resource-drop]fields
//go:noescape
...
//go:wasmimport wasi:http/types@0.2.0-rc-2023-11-10 [constructor]fields
//go:noescape
...
//go:wasmimport wasi:http/types@0.2.0-rc-2023-11-10 [static]fields.from-list
//go:noescape
...
//go:wasmimport wasi:http/types@0.2.0-rc-2023-11-10 [method]fields.append
//go:noescape
...
//go:wasmimport wasi:http/types@0.2.0-rc-2023-11-10 [method]fields.clone
//go:noescape
...
//go:wasmimport wasi:http/types@0.2.0-rc-2023-11-10 [method]fields.delete
//go:noescape
...
//go:wasmimport wasi:http/types@0.2.0-rc-2023-11-10 [method]fields.entries
//go:noescape
...
//go:wasmimport wasi:http/types@0.2.0-rc-2023-11-10 [method]fields.get
//go:noescape
...
//go:wasmimport wasi:http/types@0.2.0-rc-2023-11-10 [method]fields.set
//go:noescape
func (self Fields) wasmimport_Set(name FieldKey, value cm.List[FieldValue], result *cm.ErrResult[struct{}, HeaderError])

// FutureIncomingResponse represents the resource "wasi:http/types@0.2.0-rc-2023-11-10#future-incoming-response".
//
...
//go:wasmimport wasi:http/types@0.2.0-rc-2023-11-10 [resource-drop]future-incoming-response
//go:noescape
...
//go:wasmimport wasi:http/types@0.2.0-rc-2023-11-10 [method]future-incoming-response.get
//go:noescape
...
//go:wasmimport wasi:http/types@0.2.0-rc-2023-11-10 [method]future-incoming-response.subscribe
//go:noescape
func (self FutureIncomingResponse) wasmimport_Subscribe() Pollable

// FutureTrailers represents the resource "wasi:http/types@0.2.0-rc-2023-11-10#future-trailers".
//
...
//go:wasmimport wasi:http/types@0.2.0-rc-2023-11-10 [resource-drop]future-trailers
//go:noescape
...
//
//go:nosplit
func (self FutureTrailers) Get() cm.Option[cm.ErrResult[cm.Option[Trailers], ErrorCode]] {
	var result cm.Option[cm.ErrResult[cm.Option[Trailers], ErrorCode]]
	self.wasmimport_Get(&result)
	return result
}

//go:wasmimport wasi:http/types@0.2.0-rc-2023-11-10 [method]future-trailers.get
//go:noescape
func (self FutureTrailers) wasmimport_Get(result *cm.Option[cm.ErrResult[cm.Option[Trailers], ErrorCode]])
...
//go:wasmimport wasi:http/types@0.2.0-rc-2023-11-10 [method]future-trailers.subscribe
//go:noescape
func (self FutureTrailers) wasmimport_Subscribe() Pollable

// HeaderError represents the variant "wasi:http/types@0.2.0-rc-2023-11-10#header-error".
//
...
// Headers represents the resource "wasi:http/types@0.2.0-rc-2023-11-10#fields".
//
// See [Fields] for more information.
type Headers = Fields

// IncomingBody represents the resource "wasi:http/types@0.2.0-rc-2023-11-10#incoming-body".
//
...
//go:wasmimport wasi:http/types@0.2.0-rc-2023-11-10 [resource-drop]incoming-body
//go:noescape
...
//go:wasmimport wasi:http/types@0.2.0-rc-2023-11-10 [static]incoming-body.finish
//go:noescape
...
//go:wasmimport wasi:http/types@0.2.0-rc-2023-11-10 [method]incoming-body.stream
//go:noescape
func (self IncomingBody) wasmimport_Stream(result *cm.OKResult[InputStream, struct{}])

// IncomingRequest represents the resource "wasi:http/types@0.2.0-rc-2023-11-10#incoming-request".
//
...
//go:wasmimport wasi:http/types@0.2.0-rc-2023-11-10 [resource-drop]incoming-request
//go:noescape
...
//go:wasmimport wasi:http/types@0.2.0-rc-2023-11-10 [method]incoming-request.authority
//go:noescape
...
//go:wasmimport wasi:http/types@0.2.0-rc-2023-11-10 [method]incoming-request.consume
//go:noescape
...
//go:wasmimport wasi:http/types@0.2.0-rc-2023-11-10 [method]incoming-request.headers
//go:noescape
...
//go:wasmimport wasi:http/types@0.2.0-rc-2023-11-10 [method]incoming-request.method
//go:noescape
...
//go:wasmimport wasi:http/types@0.2.0-rc-2023-11-10 [method]incoming-request.path-with-query
//go:noescape
...
//go:wasmimport wasi:http/types@0.2.0-rc-2023-11-10 [method]incoming-request.scheme
//go:noescape
func (self IncomingRequest) wasmimport_Scheme(result *cm.Option[Scheme])

// IncomingResponse represents the resource "wasi:http/types@0.2.0-rc-2023-11-10#incoming-response".
//
...
//go:wasmimport wasi:http/types@0.2.0-rc-2023-11-10 [resource-drop]incoming-response
//go:noescape
...
//go:wasmimport wasi:http/types@0.2.0-rc-2023-11-10 [method]incoming-response.consume
//go:noescape
...
//go:wasmimport wasi:http/types@0.2.0-rc-2023-11-10 [method]incoming-response.headers
//go:noescape
...
//go:wasmimport wasi:http/types@0.2.0-rc-2023-11-10 [method]incoming-response.status
//go:noescape
func (self IncomingResponse) wasmimport_Status() StatusCode

// InputStream represents the resource "wasi:io/streams@0.2.0-rc-2023-11-10#input-stream".
//
// See [streams.InputStream] for more information.
type InputStream = streams.InputStream

// IOError represents the resource "wasi:io/error@0.2.0-rc-2023-11-10#error".
//
// See [ioerror.Error] for more information.
type IOError = ioerror.Error

// Method represents the variant "wasi:http/types@0.2.0-rc-2023-11-10#method".
//
...
// OutgoingBody represents the resource "wasi:http/types@0.2.0-rc-2023-11-10#outgoing-body".
//
...
//go:wasmimport wasi:http/types@0.2.0-rc-2023-11-10 [resource-drop]outgoing-body
//go:noescape
...
//go:wasmimport wasi:http/types@0.2.0-rc-2023-11-10 [static]outgoing-body.finish
//go:noescape
...
//go:wasmimport wasi:http/types@0.2.0-rc-2023-11-10 [method]outgoing-body.write
//go:noescape
func (self OutgoingBody) wasmimport_Write(result *cm.OKResult[OutputStream, struct{}])

// OutgoingRequest represents the resource "wasi:http/types@0.2.0-rc-2023-11-10#outgoing-request".
//
...
//go:wasmimport wasi:http/types@0.2.0-rc-2023-11-10 [resource-drop]outgoing-request
//go:noescape
...
//go:wasmimport wasi:http/types@0.2.0-rc-2023-11-10 [constructor]outgoing-request
//go:noescape
...
//go:wasmimport wasi:http/types@0.2.0-rc-2023-11-10 [method]outgoing-request.authority
//go:noescape
...
//go:wasmimport wasi:http/types@0.2.0-rc-2023-11-10 [method]outgoing-request.body
//go:noescape
...
//go:wasmimport wasi:http/types@0.2.0-rc-2023-11-10 [method]outgoing-request.headers
//go:noescape
...
//go:wasmimport wasi:http/types@0.2.0-rc-2023-11-10 [method]outgoing-request.method
//go:noescape
...
//go:wasmimport wasi:http/types@0.2.0-rc-2023-11-10 [method]outgoing-request.path-with-query
//go:noescape
...
//go:wasmimport wasi:http/types@0.2.0-rc-2023-11-10 [method]outgoing-request.scheme
//go:noescape
...
//go:wasmimport wasi:http/types@0.2.0-rc-2023-11-10 [method]outgoing-request.set-authority
//go:noescape
...
//go:wasmimport wasi:http/types@0.2.0-rc-2023-11-10 [method]outgoing-request.set-method
//go:noescape
...
//go:wasmimport wasi:http/types@0.2.0-rc-2023-11-10 [method]outgoing-request.set-path-with-query
//go:noescape
...
//go:wasmimport wasi:http/types@0.2.0-rc-2023-11-10 [method]outgoing-request.set-scheme
//go:noescape
func (self OutgoingRequest) wasmimport_SetScheme(scheme cm.Option[Scheme]) cm.Result

// OutgoingResponse represents the resource "wasi:http/types@0.2.0-rc-2023-11-10#outgoing-response".
//
...
//go:wasmimport wasi:http/types@0.2.0-rc-2023-11-10 [resource-drop]outgoing-response
//go:noescape
...
//go:wasmimport wasi:http/types@0.2.0-rc-2023-11-10 [constructor]outgoing-response
//go:noescape
...
//go:wasmimport wasi:http/types@0.2.0-rc-2023-11-10 [method]outgoing-response.body
//go:noescape
...
//go:wasmimport wasi:http/types@0.2.0-rc-2023-11-10 [method]outgoing-response.headers
//go:noescape
...
//go:wasmimport wasi:http/types@0.2.0-rc-2023-11-10 [method]outgoing-response.set-status-code
//go:noescape
...
//go:wasmimport wasi:http/types@0.2.0-rc-2023-11-10 [method]outgoing-response.status-code
//go:noescape
...
// RequestOptions represents the resource "wasi:http/types@0.2.0-rc-2023-11-10#request-options".
//
...
//go:wasmimport wasi:http/types@0.2.0-rc-2023-11-10 [resource-drop]request-options
//go:noescape
...
//go:wasmimport wasi:http/types@0.2.0-rc-2023-11-10 [constructor]request-options
//go:noescape
func wasmimport_NewRequestOptions() RequestOptions

// BetweenBytesTimeoutMs represents method "between-bytes-timeout-ms".
//
...
//
//go:nosplit
func (self RequestOptions) BetweenBytesTimeoutMs() cm.Option[Duration] {
	var result cm.Option[Duration]
	self.wasmimport_BetweenBytesTimeoutMs(&result)
	return result
}

//go:wasmimport wasi:http/types@0.2.0-rc-2023-11-10 [method]request-options.between-bytes-timeout-ms
//go:noescape
func (self RequestOptions) wasmimport_BetweenBytesTimeoutMs(result *cm.Option[Duration])

// ConnectTimeoutMs represents method "connect-timeout-ms".
//
...
//
//go:nosplit
func (self RequestOptions) ConnectTimeoutMs() cm.Option[Duration] {
	var result cm.Option[Duration]
	self.wasmimport_ConnectTimeoutMs(&result)
	return result
}

//go:wasmimport wasi:http/types@0.2.0-rc-2023-11-10 [method]request-options.connect-timeout-ms
//go:noescape
func (self RequestOptions) wasmimport_ConnectTimeoutMs(result *cm.Option[Duration])

// FirstByteTimeoutMs represents method "first-byte-timeout-ms".
//
...
//
//go:nosplit
func (self RequestOptions) FirstByteTimeoutMs() cm.Option[Duration] {
	var result cm.Option[Duration]
	self.wasmimport_FirstByteTimeoutMs(&result)
	return result
}

//go:wasmimport wasi:http/types@0.2.0-rc-2023-11-10 [method]request-options.first-byte-timeout-ms
//go:noescape
func (self RequestOptions) wasmimport_FirstByteTimeoutMs(result *cm.Option[Duration])

// SetBetweenBytesTimeoutMs represents method "set-between-bytes-timeout-ms".
//
...
//
//go:nosplit
func (self RequestOptions) SetBetweenBytesTimeoutMs(ms cm.Option[Duration]) cm.Result {
	return self.wasmimport_SetBetweenBytesTimeoutMs(ms)
}

//go:wasmimport wasi:http/types@0.2.0-rc-2023-11-10 [method]request-options.set-between-bytes-timeout-ms
//go:noescape
func (self RequestOptions) wasmimport_SetBetweenBytesTimeoutMs(ms cm.Option[Duration]) cm.Result

// SetConnectTimeoutMs represents method "set-connect-timeout-ms".
//
...
//
//go:nosplit
func (self RequestOptions) SetConnectTimeoutMs(ms cm.Option[Duration]) cm.Result {
	return self.wasmimport_SetConnectTimeoutMs(ms)
}

//go:wasmimport wasi:http/types@0.2.0-rc-2023-11-10 [method]request-options.set-connect-timeout-ms
//go:noescape
func (self RequestOptions) wasmimport_SetConnectTimeoutMs(ms cm.Option[Duration]) cm.Result

// SetFirstByteTimeoutMs represents method "set-first-byte-timeout-ms".
//
...
//
//go:nosplit
func (self RequestOptions) SetFirstByteTimeoutMs(ms cm.Option[Duration]) cm.Result {
	return self.wasmimport_SetFirstByteTimeoutMs(ms)
}

//go:wasmimport wasi:http/types@0.2.0-rc-2023-11-10 [method]request-options.set-first-byte-timeout-ms
//go:noescape
func (self RequestOptions) wasmimport_SetFirstByteTimeoutMs(ms cm.Option[Duration]) cm.Result

// ResponseOutparam represents the resource "wasi:http/types@0.2.0-rc-2023-11-10#response-outparam".
//
...
//go:wasmimport wasi:http/types@0.2.0-rc-2023-11-10 [resource-drop]response-outparam
//go:noescape
...
//go:wasmimport wasi:http/types@0.2.0-rc-2023-11-10 [static]response-outparam.set
//go:noescape
func wasmimport_ResponseOutparamSet(param ResponseOutparam, response cm.ErrResult[OutgoingResponse, ErrorCode])

// Scheme represents the variant "wasi:http/types@0.2.0-rc-2023-11-10#scheme".
//
...
// StatusCode represents the type "wasi:http/types@0.2.0-rc-2023-11-10#status-code".
//
...
// Trailers represents the resource "wasi:http/types@0.2.0-rc-2023-11-10#fields".
//
// See [Fields] for more information.
type Trailers = Fields

// HTTPErrorCode represents function "wasi:http/types@0.2.0-rc-2023-11-10#http-error-code".
//
...
//go:wasmimport wasi:http/types@0.2.0-rc-2023-11-10 http-error-code
//go:noescape
