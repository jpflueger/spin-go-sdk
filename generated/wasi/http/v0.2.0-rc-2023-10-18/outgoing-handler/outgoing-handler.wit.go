...
import (
	"github.com/fermyon/spin-go-sdk/generated/wasi/http/v0.2.0-rc-2023-10-18/types"
...
type Interface interface {
	Handle(request OutgoingRequest, options cm.Option[RequestOptions]) cm.ErrResult[FutureIncomingResponse, Error]
}
