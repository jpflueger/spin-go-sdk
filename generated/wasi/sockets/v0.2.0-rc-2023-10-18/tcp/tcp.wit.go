...
// Package tcp represents the interface "wasi:sockets/tcp@0.2.0-rc-2023-10-18".
package tcp

import (
	"github.com/fermyon/spin-go-sdk/generated/wasi/io/v0.2.0-rc-2023-10-18/poll"
	"github.com/fermyon/spin-go-sdk/generated/wasi/io/v0.2.0-rc-2023-10-18/streams"
	"github.com/fermyon/spin-go-sdk/generated/wasi/sockets/v0.2.0-rc-2023-10-18/network"
...
// ShutdownType represents the enum "wasi:sockets/tcp@0.2.0-rc-2023-10-18#shutdown-type".
//
//	enum shutdown-type {
//		receive,
//		send,
...
// TCPSocket represents the resource "wasi:sockets/tcp@0.2.0-rc-2023-10-18#tcp-socket".
//
// A TCP socket handle.
//
//	resource tcp-socket
...
//go:wasmimport wasi:sockets/tcp@0.2.0-rc-2023-10-18 [resource-drop]tcp-socket
//go:noescape
...
//
// The returned socket is bound and in the Connection state. The following properties
...
//go:wasmimport wasi:sockets/tcp@0.2.0-rc-2023-10-18 [method]tcp-socket.accept
//go:noescape
...
//go:wasmimport wasi:sockets/tcp@0.2.0-rc-2023-10-18 [method]tcp-socket.address-family
//go:noescape
...
//go:wasmimport wasi:sockets/tcp@0.2.0-rc-2023-10-18 [method]tcp-socket.finish-bind
//go:noescape
...
//go:wasmimport wasi:sockets/tcp@0.2.0-rc-2023-10-18 [method]tcp-socket.finish-connect
//go:noescape
...
//go:wasmimport wasi:sockets/tcp@0.2.0-rc-2023-10-18 [method]tcp-socket.finish-listen
//go:noescape
...
//
//go:nosplit
func (self TCPSocket) IPv6Only() cm.OKResult[bool, ErrorCode] {
	var result cm.OKResult[bool, ErrorCode]
	self.wasmimport_IPv6Only(&result)
	return result
}

//go:wasmimport wasi:sockets/tcp@0.2.0-rc-2023-10-18 [method]tcp-socket.ipv6-only
//go:noescape
func (self TCPSocket) wasmimport_IPv6Only(result *cm.OKResult[bool, ErrorCode])

// KeepAlive represents method "keep-alive".
//
...
//
//go:nosplit
func (self TCPSocket) KeepAlive() cm.OKResult[bool, ErrorCode] {
	var result cm.OKResult[bool, ErrorCode]
	self.wasmimport_KeepAlive(&result)
	return result
}

//go:wasmimport wasi:sockets/tcp@0.2.0-rc-2023-10-18 [method]tcp-socket.keep-alive
//go:noescape
func (self TCPSocket) wasmimport_KeepAlive(result *cm.OKResult[bool, ErrorCode])
...
//go:wasmimport wasi:sockets/tcp@0.2.0-rc-2023-10-18 [method]tcp-socket.local-address
//go:noescape
func (self TCPSocket) wasmimport_LocalAddress(result *cm.OKResult[IPSocketAddress, ErrorCode])

// NoDelay represents method "no-delay".
//
...
//
//go:nosplit
func (self TCPSocket) NoDelay() cm.OKResult[bool, ErrorCode] {
	var result cm.OKResult[bool, ErrorCode]
	self.wasmimport_NoDelay(&result)
	return result
}

//go:wasmimport wasi:sockets/tcp@0.2.0-rc-2023-10-18 [method]tcp-socket.no-delay
//go:noescape
func (self TCPSocket) wasmimport_NoDelay(result *cm.OKResult[bool, ErrorCode])
...
//go:wasmimport wasi:sockets/tcp@0.2.0-rc-2023-10-18 [method]tcp-socket.receive-buffer-size
//go:noescape
...
//go:wasmimport wasi:sockets/tcp@0.2.0-rc-2023-10-18 [method]tcp-socket.remote-address
//go:noescape
...
//go:wasmimport wasi:sockets/tcp@0.2.0-rc-2023-10-18 [method]tcp-socket.send-buffer-size
//go:noescape
...
//
//go:nosplit
func (self TCPSocket) SetIPv6Only(value bool) cm.ErrResult[struct{}, ErrorCode] {
	var result cm.ErrResult[struct{}, ErrorCode]
	self.wasmimport_SetIPv6Only(value, &result)
	return result
}

//go:wasmimport wasi:sockets/tcp@0.2.0-rc-2023-10-18 [method]tcp-socket.set-ipv6-only
//go:noescape
func (self TCPSocket) wasmimport_SetIPv6Only(value bool, result *cm.ErrResult[struct{}, ErrorCode])

// SetKeepAlive represents method "set-keep-alive".
//
//	set-keep-alive: func(value: bool) -> result<_, error-code>
//
//go:nosplit
func (self TCPSocket) SetKeepAlive(value bool) cm.ErrResult[struct{}, ErrorCode] {
	var result cm.ErrResult[struct{}, ErrorCode]
	self.wasmimport_SetKeepAlive(value, &result)
	return result
}

//go:wasmimport wasi:sockets/tcp@0.2.0-rc-2023-10-18 [method]tcp-socket.set-keep-alive
//go:noescape
func (self TCPSocket) wasmimport_SetKeepAlive(value bool, result *cm.ErrResult[struct{}, ErrorCode])
...
//go:wasmimport wasi:sockets/tcp@0.2.0-rc-2023-10-18 [method]tcp-socket.set-listen-backlog-size
//go:noescape
func (self TCPSocket) wasmimport_SetListenBacklogSize(value uint64, result *cm.ErrResult[struct{}, ErrorCode])

// SetNoDelay represents method "set-no-delay".
//
//	set-no-delay: func(value: bool) -> result<_, error-code>
//
//go:nosplit
func (self TCPSocket) SetNoDelay(value bool) cm.ErrResult[struct{}, ErrorCode] {
	var result cm.ErrResult[struct{}, ErrorCode]
	self.wasmimport_SetNoDelay(value, &result)
	return result
}

//go:wasmimport wasi:sockets/tcp@0.2.0-rc-2023-10-18 [method]tcp-socket.set-no-delay
//go:noescape
func (self TCPSocket) wasmimport_SetNoDelay(value bool, result *cm.ErrResult[struct{}, ErrorCode])
...
//go:wasmimport wasi:sockets/tcp@0.2.0-rc-2023-10-18 [method]tcp-socket.set-receive-buffer-size
//go:noescape
...
//go:wasmimport wasi:sockets/tcp@0.2.0-rc-2023-10-18 [method]tcp-socket.set-send-buffer-size
//go:noescape
...
//
//go:nosplit
func (self TCPSocket) SetUnicastHopLimit(value uint8) cm.ErrResult[struct{}, ErrorCode] {
	var result cm.ErrResult[struct{}, ErrorCode]
	self.wasmimport_SetUnicastHopLimit(value, &result)
	return result
}

//go:wasmimport wasi:sockets/tcp@0.2.0-rc-2023-10-18 [method]tcp-socket.set-unicast-hop-limit
//go:noescape
func (self TCPSocket) wasmimport_SetUnicastHopLimit(value uint8, result *cm.ErrResult[struct{}, ErrorCode])

// Shutdown represents method "shutdown".
//
// Initiate a graceful shutdown.
//
// - receive: the socket is not expecting to receive any more data from the peer.
// All subsequent read
// operations on the `input-stream` associated with this socket will return an End
// Of Stream indication.
// Any data still in the receive queue at time of calling `shutdown` will be discarded.
// - send: the socket is not expecting to send any more data to the peer. All subsequent
// write
...
//go:wasmimport wasi:sockets/tcp@0.2.0-rc-2023-10-18 [method]tcp-socket.shutdown
//go:noescape
...
//
// When a socket is not explicitly bound, the first invocation to a listen or connect
// operation will
...
// but the socket has `ipv6-only` enabled. (EINVAL)
...
//go:wasmimport wasi:sockets/tcp@0.2.0-rc-2023-10-18 [method]tcp-socket.start-bind
//go:noescape
...
// - If `connect` fails because an input/state validation error, the socket should
// remain usable.
// - If a connection was actually attempted but failed, the socket should become unusable
// for further network communication.
...
// but the socket has `ipv6-only` enabled. (EINVAL, EADDRNOTAVAIL on Illumos)
...
// - `invalid-state`:             The socket is already in the Listener state. (EOPNOTSUPP,
// EINVAL on Windows)
//
// # Typical `finish` errors
...
// EHOSTDOWN, ENETUNREACH, ENETDOWN)
...
//go:wasmimport wasi:sockets/tcp@0.2.0-rc-2023-10-18 [method]tcp-socket.start-connect
//go:noescape
...
//
// Unlike POSIX:
// - this function is async. This enables interactive WASI hosts to inject permission
// prompts.
...
//go:wasmimport wasi:sockets/tcp@0.2.0-rc-2023-10-18 [method]tcp-socket.start-listen
//go:noescape
...
//go:wasmimport wasi:sockets/tcp@0.2.0-rc-2023-10-18 [method]tcp-socket.subscribe
//go:noescape
...
//
//go:nosplit
func (self TCPSocket) UnicastHopLimit() cm.OKResult[uint8, ErrorCode] {
	var result cm.OKResult[uint8, ErrorCode]
	self.wasmimport_UnicastHopLimit(&result)
	return result
}

//go:wasmimport wasi:sockets/tcp@0.2.0-rc-2023-10-18 [method]tcp-socket.unicast-hop-limit
//go:noescape
func (self TCPSocket) wasmimport_UnicastHopLimit(result *cm.OKResult[uint8, ErrorCode])
