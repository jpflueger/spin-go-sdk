...
// Package udpcreatesocket represents the interface "wasi:sockets/udp-create-socket@0.2.0-rc-2023-10-18".
package udpcreatesocket

import (
	"github.com/fermyon/spin-go-sdk/generated/wasi/sockets/v0.2.0-rc-2023-10-18/network"
	"github.com/fermyon/spin-go-sdk/generated/wasi/sockets/v0.2.0-rc-2023-10-18/udp"
...
// CreateUDPSocket represents function "wasi:sockets/udp-create-socket@0.2.0-rc-2023-10-18#create-udp-socket".
//
...
//go:wasmimport wasi:sockets/udp-create-socket@0.2.0-rc-2023-10-18 create-udp-socket
//go:noescape
