...
// Package tcpcreatesocket represents the interface "wasi:sockets/tcp-create-socket@0.2.0-rc-2023-11-10".
package tcpcreatesocket

import (
	"github.com/fermyon/spin-go-sdk/generated/wasi/sockets/v0.2.0-rc-2023-11-10/network"
	"github.com/fermyon/spin-go-sdk/generated/wasi/sockets/v0.2.0-rc-2023-11-10/tcp"
...
// CreateTCPSocket represents function "wasi:sockets/tcp-create-socket@0.2.0-rc-2023-11-10#create-tcp-socket".
//
...
//go:wasmimport wasi:sockets/tcp-create-socket@0.2.0-rc-2023-11-10 create-tcp-socket
//go:noescape
