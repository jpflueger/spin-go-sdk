...
// Package ipnamelookup represents the interface "wasi:sockets/ip-name-lookup@0.2.0-rc-2023-11-10".
...
// IPAddress represents the variant "wasi:sockets/network@0.2.0-rc-2023-11-10#ip-address".
//
...
// ResolveAddressStream represents the resource "wasi:sockets/ip-name-lookup@0.2.0-rc-2023-11-10#resolve-address-stream".
//
...
//go:wasmimport wasi:sockets/ip-name-lookup@0.2.0-rc-2023-11-10 [resource-drop]resolve-address-stream
//go:noescape
...
//go:wasmimport wasi:sockets/ip-name-lookup@0.2.0-rc-2023-11-10 [method]resolve-address-stream.resolve-next-address
//go:noescape
...
//go:wasmimport wasi:sockets/ip-name-lookup@0.2.0-rc-2023-11-10 [method]resolve-address-stream.subscribe
//go:noescape
func (self ResolveAddressStream) wasmimport_Subscribe() Pollable

// ResolveAddresses represents function "wasi:sockets/ip-name-lookup@0.2.0-rc-2023-11-10#resolve-addresses".
//
...
//go:wasmimport wasi:sockets/ip-name-lookup@0.2.0-rc-2023-11-10 resolve-addresses
//go:noescape
