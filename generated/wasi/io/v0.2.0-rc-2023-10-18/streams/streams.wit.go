...
//
//	blocking-splice: func(src: input-stream, len: u64) -> result<u64, stream-error>
//
//go:nosplit
...
// the output stream.
//
//	forward: func(src: input-stream) -> result<u64, stream-error>
//
//go:nosplit
...
//
//	splice: func(src: input-stream, len: u64) -> result<u64, stream-error>
//
//go:nosplit
