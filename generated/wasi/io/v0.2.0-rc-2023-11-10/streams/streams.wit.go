...
// Package streams represents the interface "wasi:io/streams@0.2.0-rc-2023-11-10".
//
...
// StreamError represents the variant "wasi:io/streams@0.2.0-rc-2023-11-10#stream-error".
//
