...
// Package rdbmstypes represents the interface "fermyon:spin/rdbms-types@2.0.0".
package rdbmstypes
...
//		unsupported,
//	}
type DbValue cm.Variant[uint8, cm.List[uint8], int64]
...
//		db-null,
//	}
type ParameterValue cm.Variant[uint8, cm.List[uint8], int64]
