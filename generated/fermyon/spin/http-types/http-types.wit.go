...
// Package httptypes represents the interface "fermyon:spin/http-types".
package httptypes
...
// HTTPStatus represents the type "fermyon:spin/http-types#http-status".
//
...
// URI represents the type "fermyon:spin/http-types#uri".
//
//	type uri = string
type URI string
