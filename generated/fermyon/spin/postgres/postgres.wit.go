...
type Interface interface {
	Execute(address string, statement string, params cm.List[ParameterValue]) cm.ErrResult[uint64, PgError]
	Query(address string, statement string, params cm.List[ParameterValue]) cm.OKResult[RowSet, PgError]
}
