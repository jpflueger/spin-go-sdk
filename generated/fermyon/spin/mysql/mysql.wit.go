...
import (
	rdbmstypes "github.com/fermyon/spin-go-sdk/generated/fermyon/spin/rdbms-types"
...
type Interface interface {
	Execute(address string, statement string, params cm.List[ParameterValue]) cm.ErrResult[struct{}, MysqlError]
	Query(address string, statement string, params cm.List[ParameterValue]) cm.OKResult[RowSet, MysqlError]
}
