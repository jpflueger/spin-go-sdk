...
// Package llm represents the interface "fermyon:spin/llm@2.0.0".
//
...
// EmbeddingModel represents the type "fermyon:spin/llm@2.0.0#embedding-model".
//
...
// InferencingModel represents the type "fermyon:spin/llm@2.0.0#inferencing-model".
//
...
// GenerateEmbeddings represents function "fermyon:spin/llm@2.0.0#generate-embeddings".
//
...
//
//go:nosplit
func GenerateEmbeddings(model EmbeddingModel, text cm.List[string]) cm.OKResult[EmbeddingsResult, Error] {
	var result cm.OKResult[EmbeddingsResult, Error]
	wasmimport_GenerateEmbeddings(model, text, &result)
	return result
}

//go:wasmimport fermyon:spin/llm@2.0.0 generate-embeddings
//go:noescape
func wasmimport_GenerateEmbeddings(model EmbeddingModel, text cm.List[string], result *cm.OKResult[EmbeddingsResult, Error])

// Infer represents function "fermyon:spin/llm@2.0.0#infer".
//
...
//
//go:nosplit
func Infer(model InferencingModel, prompt string, params cm.Option[InferencingParams]) cm.OKResult[InferencingResult, Error] {
	var result cm.OKResult[InferencingResult, Error]
	wasmimport_Infer(model, prompt, params, &result)
	return result
}

//go:wasmimport fermyon:spin/llm@2.0.0 infer
//go:noescape
func wasmimport_Infer(model InferencingModel, prompt string, params cm.Option[InferencingParams], result *cm.OKResult[InferencingResult, Error])

type Interface interface {
	GenerateEmbeddings(model EmbeddingModel, text cm.List[string]) cm.OKResult[EmbeddingsResult, Error]
	Infer(model InferencingModel, prompt string, params cm.Option[InferencingParams]) cm.OKResult[InferencingResult, Error]
}
