...
// Package network represents the interface "wasi:sockets/network@0.2.0-rc-2023-11-10".
package network
...
// IPv4Address represents the tuple "wasi:sockets/network@0.2.0-rc-2023-11-10#ipv4-address".
//
//	type ipv4-address = tuple<u8, u8, u8, u8>
type IPv4Address [4]uint8

// IPv4SocketAddress represents the record "wasi:sockets/network@0.2.0-rc-2023-11-10#ipv4-socket-address".
//
...
// IPv6Address represents the tuple "wasi:sockets/network@0.2.0-rc-2023-11-10#ipv6-address".
//
//	type ipv6-address = tuple<u16, u16, u16, u16, u16, u16, u16, u16>
type IPv6Address [8]uint16

// IPv6SocketAddress represents the record "wasi:sockets/network@0.2.0-rc-2023-11-10#ipv6-socket-address".
//
...
//go:wasmimport wasi:sockets/network@0.2.0-rc-2023-11-10 [resource-drop]network
//go:noescape
